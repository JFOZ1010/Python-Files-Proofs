...
class Question(models.Model):
    ...
    pub_date = models.DateTimeField("Date published") #definimos el campo pub_date como un campo de tipo DateTimeField, con una etiqueta 'date published'

    #validar que las preguntas puedan ser creadas pero obligatoriamente con respuestas
